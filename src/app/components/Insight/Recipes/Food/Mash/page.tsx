...
import styles from './mash.module.css';
...
const Garlic = () => {
  ...
  return (
    <div className={styles.recipePageContainer2}>
        <Navbar/>
      <Head>
      ...
      <section className={styles.ingredientsSection2}>
        <h2>Ingredients</h2>
        <div className={styles.ingredientGrid2}>
          {[
            ...
            <motion.div
              className={styles.ingredientCard2}
              key={index}
